<template>
    <div id="signup-form">
        <section>
            <form @submit.prevent>
                <div class = "col1">
                <h3>Modify your Reservation @ {{ tempReserve.pickuplocation }}</h3>
                </div>
                <div class = "col1">
                <div>
    ...
    data(){
        return{
            reservationForm:{
                ...
                pickuplocation:this.$store.state.tempReserve.pickuplocation,
                dropofflocation:this.$store.state.tempReserve.dropofflocation
            },
            FirstNameErrorMsg: '',
            LastNameErrorMsg: '',
            TitleErrorMsg: '',
        ...
        modifyReservation(){
            ...
            if(this.IsFormValid() == true){
                this.$store.dispatch('modifyReservation',{
                    ...
                    pickuplocation: this.reservationForm.pickuplocation,
